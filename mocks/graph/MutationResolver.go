...
// CreateReply provides a mock function with given fields: ctx, parentID, tweetInput
func (_m *MutationResolver) CreateReply(ctx context.Context, parentID string, tweetInput graph.TweetInput) (*graph.Tweet, error) {
	ret := _m.Called(ctx, parentID, tweetInput)

	var r0 *graph.Tweet
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, graph.TweetInput) (*graph.Tweet, error)); ok {
		return rf(ctx, parentID, tweetInput)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, graph.TweetInput) *graph.Tweet); ok {
		r0 = rf(ctx, parentID, tweetInput)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, string, graph.TweetInput) error); ok {
		r1 = rf(ctx, parentID, tweetInput)
	} else {
		r1 = ret.Error(1)
	}
...
// CreateTweet provides a mock function with given fields: ctx, tweetInput
func (_m *MutationResolver) CreateTweet(ctx context.Context, tweetInput graph.TweetInput) (*graph.Tweet, error) {
	ret := _m.Called(ctx, tweetInput)

	var r0 *graph.Tweet
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, graph.TweetInput) (*graph.Tweet, error)); ok {
		return rf(ctx, tweetInput)
	}
	if rf, ok := ret.Get(0).(func(context.Context, graph.TweetInput) *graph.Tweet); ok {
		r0 = rf(ctx, tweetInput)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*graph.Tweet)
		}
	...
	if rf, ok := ret.Get(1).(func(context.Context, graph.TweetInput) error); ok {
		r1 = rf(ctx, tweetInput)
	} else {
		r1 = ret.Error(1)
	}
